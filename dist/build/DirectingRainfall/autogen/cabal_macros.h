...
/* package DirectingRainfall-0.1.0.0 */
#ifndef VERSION_DirectingRainfall
#define VERSION_DirectingRainfall "0.1.0.0"
#endif /* VERSION_DirectingRainfall */
#ifndef MIN_VERSION_DirectingRainfall
#define MIN_VERSION_DirectingRainfall(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_DirectingRainfall */
...
#define CURRENT_COMPONENT_ID "DirectingRainfall-0.1.0.0-ARprtZHJEFu7MaKGE77UOv-DirectingRainfall"
